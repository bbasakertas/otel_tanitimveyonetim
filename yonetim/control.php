...
<head>
  ...
  <title>Otel Tanıtım-Yönetim Paneli</title>
        ...
        <div class="menu-inner">
          <nav>
            <ul class="metismenu" id="menu">
              ...
              <li><a href="control.php?sayfa=odafilo"><i class="ti-car"></i> <span>Oda Filosu</span></a></li>
          ...
          <div class="col-lg-12 mt-2 bg-white text-center" style="min-height:500px;">
            ...
            switch ($sayfa):
              ...
              case "introresimekle":
                ...
                case "odafilo":
                  $yonetim->odafilo($baglanti);
                  break;
  
                case "odafiloguncelle":
                  $yonetim->odafiloguncelleme($baglanti);
                  break;
  
                case "odafilosil":
                  $yonetim->odafilosil($baglanti);
                  break;
  
                case "odafiloekle":
                  $yonetim->odafiloekleme($baglanti);
                  break;
                  //-------------------------------------------
